...
//   return (
//     <div className="w-full min-h-[40vh] py-5 px-2 flex flex-col gap-10 font-poppins">
//       {data.map((room) => (
...
//   return (
//     <div className="w-full min-h-[30vh] flex flex-col lg:flex-row gap-2 py-3">
//       {/* Left Section */}
...
//         {/* Thumbnail Section */}
//         <div className="w-[15%] grid grid-rows-5 gap-2 h-full ml-2">
//           {room.image.map((src, index) => (
//             <div
//               key={index}
...
//           </div>
//           <p>({room.ratingCount} Ratings) · Good</p>
//         </div>
