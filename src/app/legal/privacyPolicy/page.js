    ...
    <main className="min-h-screen bg-gray-50 py-16 px-4">
      <div className="container mx-auto max-w-4xl bg-white p-8">
        ...
        <p className="text-gray-700 leading-relaxed mt-20">
          ...
          This Privacy Notice provides details about the information we collect,
          how we use it, and the steps we take to protect it. It also explains
          how you can contact us with any questions regarding the use of your
          information.
        </p>
        ...
        <p className="text-gray-700 leading-relaxed mb-8">
          ...
          “ShreeShyamYatra.com”, "we," "us," or "our" are to Shree Shyam Yatra.
        </p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          ...
          accommodations, or booking accommodations through a third-party travel
          agency, etc.). We may provide additional privacy notices if needed for
          specific interactions.
        </p>
        <p className="text-gray-700 leading-relaxed mb-8">
          If you book a stay through us at one of our partner properties—such as
          hotels, the property manager/owner may use your personal data
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          ...
          cookie helps analyze web traffic or alerts you when you visit specific
          sites. Cookies allow web applications to respond to you personally by
          tailoring their operations to your preferences and needs.
        </p>
        <p className="text-gray-700 leading-relaxed mb-8">
          We use traffic log cookies to identify which pages are being visited,
          which helps us analyze website traffic and enhance our website to
          better meet customer needs. This information is used solely for
          statistical analysis, after which the data is removed from our system.
        </p>
